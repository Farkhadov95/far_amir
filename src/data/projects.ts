...
const projects: Project[] = [
  {
    ...
    description: [
      ...
      "Socket.io to send/receive messages in real-time",
      "Axios and React Query for retrieving and sending data from/to API",
      "Mongoose/MongoDB for Database",
      "Express.js as Node.js Framework",
      "Authentication using JWT",
    ],
    github: "https://github.com/Farkhadov95/hive_messenger",
    live: "https://hive-messenger.vercel.app",
    backend: "https://github.com/Farkhadov95/hive_server",
    image: hive,
    tools: [
      "HTML",
      "CSS",
